...
// liggen, en de kopie heette "in sync" terwijl de engine er iets anders mee plande.
{
  ...
  const ROLE: Record<keyof WorkCalendar, 'identiteit' | 'inhoud' | 'herkomst'> = {
    id: 'identiteit',
    ...
    // P6-importherkomst (rekenprofielen-etappe): alleen de XER-reader zet ze; geen bibliotheekinhoud.
    p6Source: 'herkomst',
    p6NonWorkPenaltyDates: 'herkomst',
    p6NonWorkPenaltyDatesState: 'herkomst',
  };
