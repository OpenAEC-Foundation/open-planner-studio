...
const EXPECTED_TOTAL = Object.values(EXPECTED_TOOLS).reduce((a, b) => a + b, 0); // = 41

test('tools/list levert exact de verwachte toolstelling (41) via de dispatcher', async () => {
