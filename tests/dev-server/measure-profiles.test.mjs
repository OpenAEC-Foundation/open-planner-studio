...
const delta = (nieuw, verslechterd, verbeterd, onmeetbaar = 0, groter = 0, kleiner = 0) =>
  `CELLDELTA p6 nieuw=${nieuw} verslechterd=${verslechterd} groter=${groter} verbeterd=${verbeterd} kleiner=${kleiner} onmeetbaar=${onmeetbaar} onbekend=0 ongemeten=0 totaal=15473`;
