...
if (!corpusRoot) {
  ...
  // Herpin 2026-09-23 (X12 brok 3/4 — C4, C7, C8, na merge van brok 2): alleen tf van de negatieve
  // kandidaat schuift, regressed 1591 → 1666 / unchanged 12086 → 12011 (som 13677 gelijk); ls/lf/es/ef/ff
  // en `synthetic-zero-regression` ongewijzigd. Meer detectie, geen verlies.
