...
| cel-baseline + `measure:profiles` | `claude/rekenprofielen-celbaseline` | fixronde 3 klaar (`2e6970ac`, gepusht): orakelhash + `OPS_XER_GATE_PINS` + corpusgroei-modus; her-check 3 loopt |
...
| baan D deel 1: D1, D2, D7, D8, D10-voorbereiding | `claude/rekenprofielen-baan-d` | klaar (`05a9491a`, gepusht); critreview loopt; deel 2 (D3–D6, D10-pin, verify:conventions in `verify`) ná merge van C. Besluit orkestrator: A19 (per-bestand) blijft ook bij een sjabloonkeuze staan |
