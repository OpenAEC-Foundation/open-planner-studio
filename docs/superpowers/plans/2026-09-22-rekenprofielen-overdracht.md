...
7. **B3, B4 en A17 (uit PR #109) hebben op de P6-populatie 0 effect** (manifest-meting 23-09); ze zijn
   ...
   ook B3/B4/A17 op P6=uit (register blijft; regel B), in een aparte commit met meting 0/0; niet zelf
   gedaan omdat het de oudere etappe (#109) raakt. B1/B2/B5 blijven aan (Hotel/Sample/ashspace dragen ze).
