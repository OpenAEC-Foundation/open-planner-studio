...
| rekenprofielen (etappe) | `claude/rekenprofielen` (bovenop de PR-branch) | kop `39418571`: A, B, C, D(+fixes), cellen, X12-brok 1; `verify` groen op `1fe5dfc8` (opnieuw draaien op de kop vóór de PR); eindreview I4 = landen-met-fixes → fixes verwerkt, her-check loopt; I5 gebruikstest loopt; daarna I6 draft-PR gestapeld op #109 |
