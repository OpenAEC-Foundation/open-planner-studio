...
**Stand 2026-09-24 ochtend:** X12 = **284** (brok 6 gemerged, `40b90b7f`; schuld 0) zesassige afwijkingen over de P6-doorgerekende orakels
...
8. **HarbourPointe: 81 cellen zijn P6-uitvoer die verouderd is t.o.v. de opgeslagen invoer** (24-09,
   ...
   taakniveau-uitsluiting die het manifest nu niet kent. De overige 43: 34 ALAP (C10, geparkeerd op brok 5,
...
| X12 naar nul — brok 7: C10 ALAP (`p6AlapPositionedFromSuccessors`, geparkeerd op brok 5 `d9973123`) opnieuw op de nieuwe kop | `claude/x12-brok7-c10-alap` (basis `40b90b7f`; worktree `agent-x12-brok7-c10-alap`) | gestart 24-09 ~04:00: patch van brok 5 overzetten, meten mét Hotel (HarbourPointe-onderzoek: 34 cellen ALAP; experiment A/B gaf Hotel 12 slechter) — landt alleen bij 0 slechter/0 groter |
| restant-onderzoek OZB 42 / Sample 12 / Hotel 8 / Roads 6 / DCP-03 92 | agent-worktree (detached, docs-only) | gestart 24-09 ~04:00: afleidbaar of niet, per cel bewijs; uitkomst voedt §1d |
