...
| `specs/2026-09-04-spec-taaktypes-opgeslagen-werk.md` | **actief ontwerp, nog niet gebouwd** — taaktypes/werkregels, opgeslagen werk per toewijzing en effort-driven bewerken; opvolger van `specs/2026-08-18-spec-taaktypes-effort-driven.md`. Bevat de MSP/P6-documentatievergelijking, de regeltabel, de meetlat (31 bewerkingen) en drie open beslispunten (8–10). Bouwt pas ná de tweede XER-merge. |
