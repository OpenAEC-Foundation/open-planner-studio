...
2. **Register-rij** in `CONVENTIONS` (`src/engine/scheduler/conventions/registry.ts`): groep (`A`, `B`
   ...
   `p6Source` —, `LEGACY_XER_ALSO_ON_X12` (C1–C9, C11 en C12) geeft `d.builtIn.p6`, de P6-profielwaarde (zo'n bestand
...
6. **Gids**: één regel onder "De zesentwintig conventies" in `public/docs/{nl,en}/gids-rekenprofielen.md`
