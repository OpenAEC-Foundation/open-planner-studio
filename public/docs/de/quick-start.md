...
- Sie wissen jetzt, wie die Schaltflächen funktionieren; wenn Sie wissen wollen, was einen Terminplan verlässlich macht — Granularität, Verknüpfungen, Einschränkungen, Puffer, Baseline —, lesen Sie die Anleitung [Gut planen: von den Anforderungen zu einem verlässlichen Terminplan](docs://gids-goed-plannen).
