...
Dasselbe gilt für ihre **Ist-Termine**. Der **Ist-Anfang** einer Phase ist der früheste Ist-Anfang der Aufgaben darunter, sobald eine begonnen hat. Ihr **Ist-Ende** ist das späteste Ist-Ende, aber erst, wenn alle Aufgaben darunter fertig sind: Solange noch eine läuft, hat die Phase kein Ist-Ende. Diese abgeleiteten Termine gehen auch in die Exporte und in die IFC-Datei ein, und die beiden Ausnahmen unten gelten auch für sie.
