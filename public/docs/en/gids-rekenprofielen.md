...
- **Free float in the task's own calendar** (Primavera P6) — the free float of an open task over a finish-to-start relationship without lag counts in the task's own calendar, not in the successor's. This applies only to hour-based schedules.
