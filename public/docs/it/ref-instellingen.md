...
## Statistiche (pulsante nella scheda Applicazione)

Si apre da **Impostazioni** → scheda **Applicazione** → **Statistiche…**; è volutamente una finestra separata dietro un pulsante, non una scheda a sé.
