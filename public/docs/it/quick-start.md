...
- Vuoi questi dati anche come colonne nella tabella delle attività, invece di dover aprire ogni attività? Nella scheda **Tabella**, **Critica** e **Margine totale** sono già nella tabella per impostazione predefinita. Nell'elenco delle attività accanto al Gantt li aggiungi con il più a destra nell'intestazione della tabella: apre il selettore delle colonne, dove scegli un campo alla volta sotto **Calcolato**. Vedi [Scelta delle colonne](docs://ref-kolommen).
...
- Ora sai come funzionano i pulsanti; se vuoi sapere che cosa rende affidabile un programma — granularità, legami, vincoli, scorrimento, baseline — leggi la guida [Pianificare bene](docs://gids-goed-plannen).
