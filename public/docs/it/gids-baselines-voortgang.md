...
Lo stesso vale per le sue **date effettive**. L'**Inizio effettivo** di una fase è l'inizio effettivo più precoce delle attività sottostanti, appena una è iniziata. La sua **Fine effettiva** è la fine effettiva più tardiva, ma solo quando tutte le attività sottostanti sono finite: finché una è ancora in corso, la fase non ha una fine effettiva. Queste date derivate finiscono anche nelle esportazioni e nel file IFC, e le due eccezioni qui sotto valgono anche per loro.
