...
Sotto la tabella delle attività, accanto alle barre, si trova il **selettore di risorse**: un elenco con "Tutte le risorse" in alto e ogni risorsa sotto, ciascuna con un punto rosso se quella risorsa è sovrallocata da qualche parte. Fai clic su un nome per ingrandire quella singola risorsa — l'istogramma si riscala sul suo carico e sulla sua capacità soltanto. Fai clic di nuovo su "Tutte le risorse" per vedere di nuovo la somma di tutte le risorse. Oltre a fare clic, puoi anche scorrere le risorse con i pulsanti **Precedente**/**Successiva** nel gruppo della barra multifunzione **Istogramma**, senza toccare il selettore stesso.
