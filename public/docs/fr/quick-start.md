...
- Vous savez maintenant comment fonctionnent les boutons ; pour savoir ce qui rend un planning fiable — granularité, liens, contraintes, marge, baseline — lisez le guide [Bien planifier : des exigences à un planning fiable](docs://gids-goed-plannen).
