...
Il en va de même pour ses **dates réelles**. Le **Début réel** d'une phase est le début réel le plus précoce des tâches en dessous, dès que l'une a commencé. Sa **Fin réelle** est la fin réelle la plus tardive, mais seulement lorsque toutes les tâches en dessous sont finies : tant que l'une est encore en cours, la phase n'a pas de fin réelle. Ces dates dérivées figurent aussi dans les exports et dans le fichier IFC, et les deux exceptions ci-dessous s'y appliquent également.
