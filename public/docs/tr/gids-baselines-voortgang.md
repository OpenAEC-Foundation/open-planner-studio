...
Aynı şey **gerçek tarihleri** için de geçerlidir. Bir aşamanın **Gerçek başlangıç** tarihi, biri başladığı anda altındaki görevlerin en erken gerçek başlangıcıdır. **Gerçek bitiş** tarihi en geç gerçek bitiştir, ancak yalnızca altındaki tüm görevler bittiğinde: biri hâlâ sürerken aşamanın gerçek bitişi yoktur. Bu türetilmiş tarihler dışa aktarımlara ve IFC dosyasına da geçer; aşağıdaki iki istisna bunlar için de geçerlidir.
