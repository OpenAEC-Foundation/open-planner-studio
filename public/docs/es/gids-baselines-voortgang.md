...
Lo mismo vale para sus **fechas reales**. El **Inicio real** de una fase es el inicio real más temprano de las tareas de debajo, en cuanto una ha empezado. Su **Fin real** es el fin real más tardío, pero solo cuando todas las tareas de debajo han terminado: mientras una siga en curso, la fase no tiene fin real. Estas fechas derivadas también pasan a las exportaciones y al archivo IFC, y las dos excepciones de abajo también se aplican a ellas.
