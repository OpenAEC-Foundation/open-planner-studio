...
- Ya sabe cómo funcionan los botones; si quiere saber qué hace fiable a un cronograma — granularidad, vínculos, restricciones, holgura, baseline —, lea la guía [Planificar bien](docs://gids-goed-plannen).
