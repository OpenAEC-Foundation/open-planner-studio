...
- Já sabe como funcionam os botões; se quiser saber o que torna um planeamento fiável — granularidade, ligações, restrições, folga, baseline —, leia o guia [Planear bem](docs://gids-goed-plannen).
