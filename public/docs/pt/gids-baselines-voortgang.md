...
O mesmo vale para as suas **datas reais**. O **Início real** de uma fase é o início real mais cedo das tarefas por baixo, assim que uma começou. O seu **Fim real** é o fim real mais tardio, mas só quando todas as tarefas por baixo terminaram: enquanto uma ainda estiver a decorrer, a fase não tem fim real. Estas datas derivadas também entram nas exportações e no ficheiro IFC, e as duas exceções abaixo também se aplicam a elas.
