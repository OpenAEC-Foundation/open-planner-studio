...
- **Legacy-functies** — een apart, gemarkeerd blok onderaan met functies die zijn vervangen. **Klassieke weergaveknoppen tonen** zet de losse knoppen Kolommen, Filter, Groeperen en Sorteren terug op het tabblad Beeld; hun functie zit nu in de layoutknoppen en het layoutvenster (zie de gids Layouts). Standaard uit.
