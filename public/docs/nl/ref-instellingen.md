...
Alle drie tonen exact dezelfde instellingen, verdeeld over drie tabs: **Algemeen**, **Taal** en **Tijdlijn / Zoomen**.
...
- **Versie** — het versienummer van de app (alleen-lezen).
- **Updates** — **Controleren op updates** opent het update-venster. Updates installeren werkt alleen in de desktop-app; Snap- en AppImage-installaties updaten via hun eigen kanaal.
- **Standaard zoom** — het standaard-zoomniveau (alleen-lezen, 30 px/dag).
- **Debug-terminal** — **Debug-terminal inschakelen** toont het logpaneel voor probleemonderzoek.
- **Projectinformatie...** — snelkoppeling naar het venster [Projectinformatie](docs://ref-projectgegevens).
...
- **Taal** — de weergavetaal van de app; veertien talen, direct toegepast.
