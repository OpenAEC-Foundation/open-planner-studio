...
- **Vrije speling in de eigen kalender** (Primavera P6) — de vrije speling van een open taak telt per relatie in de kalender van de taak zelf, niet in die van de opvolger. Dat geldt voor elk relatietype en ook met een lag in werktijd, zolang die lag op de kalender van de voorganger rekent. Voorbeeld: een taak werkt tot 17:00, haar opvolger (start-start met lag) tot 16:00. Valt de relatiegrens om 16:00, dan begint de opvolger pas de volgende ochtend en heeft de taak één uur vrije speling. Lags in kalendertijd, procentlags en lags op een andere lagkalender zijn niet gemeten en houden de gewone berekening.
