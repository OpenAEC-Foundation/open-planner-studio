...
## De zeventien conventies

Onder Open Planner Studio staan ze alle zeventien uit.
...
Het profiel wordt in het IFC-bestand opgeslagen, met alle zeventien waarden, zodat het bestand overal hetzelfde rekent. Een project met het standaardprofiel slaat niets extra's op. Oudere versies van Open Planner Studio kennen het profiel niet: zij lezen alleen de reken-opties en de twee voortgangsconventies van Microsoft Project, en rekenen een P6-project zonder P6-conventies.
