...
## De tweeëntwintig conventies

Onder Open Planner Studio staan ze alle tweeëntwintig uit.
...
- **ALAP-taak zo laat als de opvolgers toestaan** (Primavera P6) — een taak met de beperking *zo laat mogelijk* die nog niet gestart is, eindigt precies waar haar opvolgers het toelaten, op de minuut nauwkeurig; een keten van zulke taken sluit aaneen. Haar eigen geplande start telt daarbij niet, ook niet als ondergrens. De opvolgers schuiven niet. Staat de conventie uit, dan schuift de taak in hele werkdagen op met haar vrije speling.
...
Het profiel wordt in het IFC-bestand opgeslagen, met alle tweeëntwintig waarden, zodat het bestand overal hetzelfde rekent. Een project met het standaardprofiel slaat niets extra's op. Oudere versies van Open Planner Studio kennen het profiel niet: zij lezen alleen de reken-opties en de twee voortgangsconventies van Microsoft Project, en rekenen een P6-project zonder P6-conventies.
