...
4. Wil je in plaats daarvan twee taken koppelen zonder te slepen? Selecteer eerst de voorganger en dan (met Ctrl/Cmd ingedrukt) de opvolger, en kies **Relatie → Geselecteerde taken koppelen** op het linttabblad **Start**, **Planning** of **Tabel** — die actie is alleen beschikbaar als er precies twee taken geselecteerd zijn, in die volgorde.
...
- Ben je nog geen planner? Lees dan eerst de gids [Goed plannen](docs://gids-goed-plannen): daarin staat wat een planning betrouwbaar maakt — granulariteit, relaties, constraints, speling en baseline.
- Wil je liever een visuele rondleiding langs de belangrijkste onderdelen van het scherm? Herstart de rondleiding via **Instellingen** → tab **Geavanceerd** → **Rondleiding starten**, of via **Bestand** → **Rondleiding starten**.
