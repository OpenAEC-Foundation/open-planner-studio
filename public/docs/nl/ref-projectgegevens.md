...
Bovenaan kies je het **Rekenprofiel**: Open Planner Studio, Primavera P6, Microsoft Project of een eigen sjabloon. Daaronder staan de zesentwintig **Conventies van dit profiel**; zet je er één om, dan maakt Open Planner Studio een eigen kopie van het profiel. Hoe dat werkt staat in de gids **Rekenprofielen** (Backstage → Help).
