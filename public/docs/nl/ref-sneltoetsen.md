...
De volledige, altijd actuele sneltoetsenlijst zit in de app zelf: het venster **Sneltoetsen**. Deze documentatie dupliceert die lijst bewust niet — het venster wordt rechtstreeks uit de app opgebouwd en loopt dus nooit achter.
...
- **Tabel** — de toetsen binnen een taakcel: Tab/Shift+Tab tussen cellen, Enter of F2 om te
  ...
  te voegen en Delete om alleen de celinhoud te wissen (niet de taak zelf).
...
- [Sneltoetsen & bediening](docs://gids-sneltoetsen-bediening) — de werkwijze eromheen: contextmenu's, muisbediening, slepen en zoomen.
