...
Dit hoofdstuk bevatte een mappenboom uit de ontwerpfase. Die is verwijderd: hij beschreef
grotendeels code die nooit bestaan heeft (`src/api/`, `documentStore.ts`, diverse renderers
