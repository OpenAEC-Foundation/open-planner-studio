...
basis `p6 | msproject | ops` + overrides) levert eenentwintig **conventies** (`ConventionKey`, booleans);
...
actie naar Projectinfo. IFC: `OPS_SchedulingProfile` (alle eenentwintig opgelost plus de letterlijke afwijkingen, alleen ≠ standaardprofiel)
