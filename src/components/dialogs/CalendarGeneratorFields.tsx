...
export function CalendarGeneratorFields({
  ...
  return (
    <div className="flex flex-col gap-3 text-small leading-4" data-ops-calendar-generator>
      ...
      {constructionMode && value.country === 'NL' && (
        <div className="flex flex-col gap-1">
          ...
          {value.bouwvak !== 'geen' && (
            <span className="!text-body italic text-text-secondary">
        ...
        {expanded && preview.holidays.length > 0 && (
          <div className="max-h-32 overflow-y-auto flex flex-col gap-0.5 pl-5">
            {preview.holidays.map((h, i) => (
              <div key={i} className="flex justify-between gap-2 !text-body text-text-secondary">
