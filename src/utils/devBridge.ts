...
function roundTrip() {
  ...
  const content = writeIFC(s.project, s.calendar, s.tasks, s.sequences, s.resources, s.assignments, s.activityCodeTypes, s.customFieldDefs, s.calendars, s.baselines, s.activeBaselineId);
