...
/** De waarde van een conventie die in een oud XER-blok ontbreekt: B1–B5 en C1–C9 op hun P6-waarde
 ...
 *    B3/B4 sinds 2026-09-23 uit), afwezige C1–C8 op hun P6-waarde (`LEGACY_XER_ALSO_ON_X12`). Afwijkingen = verschil met p6;
