...
export interface XerResourceReadContext {
  ...
  /** Geplande werkminuten per activiteit, voor de "afwezig ⇒ afgeleid"-toets van de
   *  TASKRSRC-werkhoeveelheden. Optioneel: zonder deze kaart worden geen werkvelden gezet. */
