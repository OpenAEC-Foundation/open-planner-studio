// Pure hulpfunctie die een sleep-gebaar van N GETOONDE kolommen vertaalt naar een datum. Los van
// `useBarDrag.ts` zodat de kern-rekenkunde headless testbaar is (`tests/planning/`) zonder de
// hook/DOM-listeners te hoeven simuleren.
//
