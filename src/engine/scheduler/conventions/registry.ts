...
export const CONVENTIONS: readonly ConventionDescriptor[] = [
  ...
  convention('p6CompletedPhysicalAtDataDate', 'C', 'completedWork', P6_ONLY, false, false, SINCE_X12_BROK3),     // C5 voltooide fysieke-voortgangstaak; alleen CP_Phys gemeten (besluit 24-09 smal)
  ...
  convention('p6AlapPositionedFromSuccessors', 'C', 'float', P6_ONLY, false, false, SINCE_X12_BROK10),      // C14 ALAP-taak zo laat als de opvolgers toestaan
];
