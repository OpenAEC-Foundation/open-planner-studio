 ...
 *  - **Conventies** (`ConventionKey`, tweeëntwintig booleans): regels die per planningspakket verschillen.
...
/** Groep C, brok 3 (out-of-sequence en CP_Phys). */
...
/** Groep C, brok 5 (ALAP vanuit de opvolgers). */
const SINCE_X12_BROK5 = '2026-09-23';
 ...
 *  Bijlage-A-nummers: A12, A13, A15–A20, A22, A23, B1–B5; daarna C1–C3 (X12 naar nul, brok 2), C4 (brok 3), C6–C7 (brok 4), C9 (brok 5; C8 is
 *  gemeten maar niet geland). */
export const CONVENTIONS: readonly ConventionDescriptor[] = [
  ...
  // C1–C4, C6–C7, C9: docblok met P6/MS Project/OPS en bron bij de sleutel in `types/project.ts`.
  ...
  convention('p6FinishFinishStartMilestoneLateFinish', 'C', P6_ONLY, false, false, SINCE_X12_BROK4), // C6
  convention('p6StartedTaskIgnoresPlannedStartFloor', 'C', P6_ONLY, false, false, SINCE_X12_BROK4),  // C7
  convention('p6AlapPositionedFromSuccessors', 'C', P6_ONLY, false, false, SINCE_X12_BROK5),        // C9
];
...
/** Basis + afwijkingen ⇒ alle tweeëntwintig conventies. Afwezig profiel ≡ `ops` zonder afwijkingen.
